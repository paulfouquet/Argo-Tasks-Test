...
* allow to validate asset checksums only TDE-1134 ([#982](https://github.com/paulfouquet/argo-tasks-test/issues/982))
...
* add new fields for GitHub PR TDE-1100 ([#923](https://github.com/paulfouquet/argo-tasks-test/issues/923)) ([3f53dc9](https://github.com/paulfouquet/argo-tasks-test/commit/3f53dc9188e37ab42c1adbaf260d19e5e30b8027))
* add ticket numbers to the suffixes of commits and branches TDE-1146 ([#962](https://github.com/paulfouquet/argo-tasks-test/issues/962)) ([b99db86](https://github.com/paulfouquet/argo-tasks-test/commit/b99db861a16977fad81f7dde66d72d6a4f985a96))
...
* allow paths to be split on ";" or "\n" ([#992](https://github.com/paulfouquet/argo-tasks-test/issues/992)) ([7284b23](https://github.com/paulfouquet/argo-tasks-test/commit/7284b23bdf0224cce2075246106b930fafd29208))
* allow to validate asset checksums only TDE-1134 ([#982](https://github.com/paulfouquet/argo-tasks-test/issues/982)) ([aca5939](https://github.com/paulfouquet/argo-tasks-test/commit/aca59393016ae92a9a36bec0e0fb62e63cf98e5f))
...
* **basemaps:** Get vector title from the collection.json file. BM-1017 ([#970](https://github.com/paulfouquet/argo-tasks-test/issues/970)) ([73f912f](https://github.com/paulfouquet/argo-tasks-test/commit/73f912f2ecd62c98a070944d5ef8b2749fafa145))
...
* **basemaps:** Should skip creating pull request when exist instead of throwing errors. BM-1018 ([#965](https://github.com/paulfouquet/argo-tasks-test/issues/965)) ([b2b026e](https://github.com/paulfouquet/argo-tasks-test/commit/b2b026e95ce9f3a6394d21d3332342485a0c08a5))
* **basemaps:** Update the create-pr cli to add new individual vector tileset. BM-992 ([#933](https://github.com/paulfouquet/argo-tasks-test/issues/933)) ([9234ffb](https://github.com/paulfouquet/argo-tasks-test/commit/9234ffb45d55918c0b7bd38b209ce91cb21bd185))
* **basemaps:** Update the create-pr cli to support elevation config. BM-936 ([#953](https://github.com/paulfouquet/argo-tasks-test/issues/953)) ([1ddd8fb](https://github.com/paulfouquet/argo-tasks-test/commit/1ddd8fbfec78c4283541de66f76b1d27512944d8))
...
* detects and error if the tiff is not 8 bits TDE-895 ([#890](https://github.com/paulfouquet/argo-tasks-test/issues/890)) ([9e639b7](https://github.com/paulfouquet/argo-tasks-test/commit/9e639b7fae9bd63c9a938a3f1f2139dab4c6a921))
...
* EAI_AGAIN middleware TDE-1114 ([#949](https://github.com/paulfouquet/argo-tasks-test/issues/949)) ([d09c718](https://github.com/paulfouquet/argo-tasks-test/commit/d09c7187e9a2f592b75f048bb3cadfc824da5e4f))
...
* force fully qualified domains for s3 requests TDE-1084 ([#940](https://github.com/paulfouquet/argo-tasks-test/issues/940)) ([3fdbf98](https://github.com/paulfouquet/argo-tasks-test/commit/3fdbf98b600ca27d67bbc807dedad2f1bf16029b))
...
* stac validate links checksum TDE-1134 ([#972](https://github.com/paulfouquet/argo-tasks-test/issues/972)) ([3bd091c](https://github.com/paulfouquet/argo-tasks-test/commit/3bd091cf9bc20bb190025610cbe859be1329b067))
...
* verify multihash when copy TDE-1181 TDE-1172 ([#1001](https://github.com/paulfouquet/argo-tasks-test/issues/1001)) ([84e261b](https://github.com/paulfouquet/argo-tasks-test/commit/84e261b99829a136eadd90ba1c1d39c4d5da58be))
...
* **basemaps:** Fix the aerial config path for create pr cli. ([#1013](https://github.com/paulfouquet/argo-tasks-test/issues/1013)) ([eed59e9](https://github.com/paulfouquet/argo-tasks-test/commit/eed59e9833176be7480134430b1d25ef12623d99))
* **basemaps:** Fix the collection.json path for the vector data. ([#987](https://github.com/paulfouquet/argo-tasks-test/issues/987)) ([17c8d89](https://github.com/paulfouquet/argo-tasks-test/commit/17c8d89a75bcd1b9325db9a69ca111b374c46c6b))
...
* **basemaps:** Fix the event category is not parsed and populated in the pull request. BM-982 ([#915](https://github.com/paulfouquet/argo-tasks-test/issues/915)) ([125cfd5](https://github.com/paulfouquet/argo-tasks-test/commit/125cfd51f67045b92d6d361064634db5121cc3ca))
* **basemaps:** Fix the output url path which got additional slash. ([#1023](https://github.com/paulfouquet/argo-tasks-test/issues/1023)) ([2cca93e](https://github.com/paulfouquet/argo-tasks-test/commit/2cca93e6854228bbef167de27e110a90db58024a))
...
* **basemaps:** Keep the existing settings when replacing existing layer. ([#1024](https://github.com/paulfouquet/argo-tasks-test/issues/1024)) ([fc736f5](https://github.com/paulfouquet/argo-tasks-test/commit/fc736f5bc9bd23a66939ea8ab15e3493e110ec84))
* build process where it doesnt like " " ([#1049](https://github.com/paulfouquet/argo-tasks-test/issues/1049)) ([90bce27](https://github.com/paulfouquet/argo-tasks-test/commit/90bce27bdbb602a616b8cd08857e4b6405a7c8cc))
* Change bareword key to variable reference TDE-1100 ([#935](https://github.com/paulfouquet/argo-tasks-test/issues/935)) ([b710d87](https://github.com/paulfouquet/argo-tasks-test/commit/b710d87084af6c1af9b11b089b865276660e1737))
...
* handle missing elevation basemaps config-url TDE-1100 ([#931](https://github.com/paulfouquet/argo-tasks-test/issues/931)) ([b025faa](https://github.com/paulfouquet/argo-tasks-test/commit/b025faa3931070d58ce52a6c5fd7767c69b09187))
...
* only validate the tiffs are 8 bit if the preset is webp TDE-1151 TDE-895 ([#966](https://github.com/paulfouquet/argo-tasks-test/issues/966)) ([bf1cc94](https://github.com/paulfouquet/argo-tasks-test/commit/bf1cc946cc4d195f11ee658ce56e4d370918d455))
* prevent deadlock when validating bits per sample TDE-1201 ([#1007](https://github.com/paulfouquet/argo-tasks-test/issues/1007)) ([5d44748](https://github.com/paulfouquet/argo-tasks-test/commit/5d44748aace4d7c837e1afb4ebcbd7fd02ad30c7))
...
* **stac-validate:** cache json schema objects to reduce network failures TDE-1212 ([#1029](https://github.com/paulfouquet/argo-tasks-test/issues/1029)) ([0338068](https://github.com/paulfouquet/argo-tasks-test/commit/0338068cf5cf31129ff8de0b8617b55cb0f4925a))
...
* **stac-validate:** work around race condition  when validating 100s of documents TDE-1212 ([#1040](https://github.com/paulfouquet/argo-tasks-test/issues/1040)) ([1d7f5d2](https://github.com/paulfouquet/argo-tasks-test/commit/1d7f5d2ea1191769c5b788eeb6a46d495fc1d6ff))
...
* uniform checksum s3 metadata key TDE-1181 ([#999](https://github.com/paulfouquet/argo-tasks-test/issues/999)) ([c177234](https://github.com/paulfouquet/argo-tasks-test/commit/c17723499e7c55cad5559fd9eeb81376061f4aa2))
...
* Use Pacific/Auckland time zone for collection years TDE-1066 ([#946](https://github.com/paulfouquet/argo-tasks-test/issues/946)) ([cd63f09](https://github.com/paulfouquet/argo-tasks-test/commit/cd63f0937676825a7ce2a1595d66f86ff8230716))
* validate band information is consistent ([#1017](https://github.com/paulfouquet/argo-tasks-test/issues/1017)) ([ec64f65](https://github.com/paulfouquet/argo-tasks-test/commit/ec64f6588de7133f186a0f66cb027c3bf52f7959))
